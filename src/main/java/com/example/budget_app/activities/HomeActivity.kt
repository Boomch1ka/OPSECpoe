...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navView.setNavigationItemSelectedListener { item ->
            when (item.itemId) {
                ...
                R.id.nav_expense -> Toast.makeText(
                    this,
                    "Expenses option clicked",
                    Toast.LENGTH_SHORT
                ).show()
                ...
                R.id.nav_progress -> Toast.makeText(
                    this,
                    "Progress option clicked",
                    Toast.LENGTH_SHORT
                ).show()
                ...
                R.id.nav_currency_converter -> startActivity(
                    Intent(
                        this,
                ...
                R.id.nav_budget_tips -> startActivity(Intent(this, BudgetTips::class.java))
            }
            drawerLayout.closeDrawers()
            true
        }
        ...
        saveGoalButton.setOnClickListener {
            ...
            if (amount != null) {
                lifecycleScope.launch {
                    ...
                    Toast.makeText(this@HomeActivity, "Budget goal updated", Toast.LENGTH_SHORT)
                        .show()
                ...
                Toast.makeText(this@HomeActivity, "Please enter a valid number", Toast.LENGTH_SHORT)
                    .show()
            }
        }
        ...
        val graphBtn = findViewById<Button>(R.id.graphButton)
    ...
    private fun loadTotalsForUserBetweenDates(userId: Long, startDate: Long, endDate: Long) {
        ...
        lifecycleScope.launch {
            val spendList =
                expenseDao.getTotalSpentPerCategoryBetweenDates(userId, startDate, endDate)
            runOnUiThread {
